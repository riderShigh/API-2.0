		...
		for j in xrange(0,10):
			...
			if match['participants'][j]['championId'] == int(thisChamp):
				...
				for itemSlot in xrange(0,7):
					...
					if thisMatchStats[itemStr]==3717 or thisMatchStats[itemStr]==3721 or thisMatchStats[itemStr]==3725: thisMatchStats[itemStr] = 3709;
					if thisMatchStats[itemStr]==3714 or thisMatchStats[itemStr]==3719 or thisMatchStats[itemStr]==3723: thisMatchStats[itemStr] = 3707;
